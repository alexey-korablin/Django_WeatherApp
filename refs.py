...
# РАБОТА С БД
#
# после изменений в файле models.py необходимо сделать миграцию в БД. Команда: python manage.py makemigrations
# для отображения таблицы в панели администратора нужно добавить ее в файл admin.py
# .